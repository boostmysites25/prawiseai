              ...
              <div className="absolute left-0 top-0 w-full p-3 h-full flex items-center justify-center bg-black/60">
                <div className="text-white space-y-3 text-center">
                  <p className="font-sans text-3xl sm:text-4xl font-bold">
                    Schedule a product acceleration workshop
                  </p>
                  <p className="description">
                    In a 60-minute session we’ll map opportunities, define success metrics, and outline the squad that gets you from idea to launch.
                  </p>
                </div>
              </div>
            </div>
      ...
      >
        ...
        <div className="wrapper flex flex-col items-center gap-5 z-10">
          ...
          >
            ...
            {isWebDevelopment
              ? "Bring your product vision to life with resilient, conversion-driven web platforms."
              : "Deliver mobile experiences that delight users, unlock revenue, and keep evolving."}
          </h1>
          <p data-aos="fade-up" className="text-center max-w-6xl description">
            {isWebDevelopment
              ? "From headless commerce to content-rich platforms, we architect and ship full-stack solutions that are fast, accessible, and easy to scale."
              : "Our mobile team blends native quality with intelligent automation to deliver apps your customers rely on every day."}
          </p>
