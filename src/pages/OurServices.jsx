  ...
  return (
    <>
      ...
      <PageBanner
        ...
        banner={banner}
        position={"left"}
        description="Four integrated studios—web, mobile, AI, and data—working as one product team to deliver intelligent digital experiences."
      />
        ...
        <div className="wrapper">
          <div className="mx-auto flex max-w-4xl flex-col gap-4 text-center">
            ...
            <h2 className="heading leading-tight">
              Tailored squads that plug into your roadmap and ship outcomes fast
            </h2>
            <p className="description text-[#2d2d2d]/80">
              From idea validation to scaling in production, our teams combine strategy, design, engineering, and AI to help you build experiences customers love and your teams can sustain.
            </p>
          </div>
          <div className="">
